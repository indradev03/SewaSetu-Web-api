...
export default function DonationDetailsModal({
  ...
  const canApprove = donation.adminStatus === "Pending";
  const canReject = donation.adminStatus === "Pending";
          ...
          <div className="flex items-center justify-center gap-3 mt-8 pt-6 border-t border-gray-100">
            ...
            {canApprove && (
              <Button
                onClick={onApprove}
                variant="green"
                className="flex-1 flex justify-center items-center rounded-xl text-sm py-3"
                disabled={processing}
              >
                {" "}
